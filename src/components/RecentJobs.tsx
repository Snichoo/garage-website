...
const slides: Slide[] = [
  {
    hero: {
      ...
      alt: "Recent garage door motor replacement",
      label: "Garage door motor replacement",
    },
    topRight: {
      src: "/images/gallery/07-4.jpg",
      alt: "Recent spring repair on a heavy double sectional door",
      label: "Spring repair",
    },
    bottomRight: {
      src: "/images/gallery/08-1.jpg",
      alt: "Automatic opener installation on a tilt door",
      label: "Automatic opener installation",
    },
  },
  {
    hero: {
      src: "/images/gallery/04-5.jpg",
      alt: "Track alignment and full service",
      label: "Track alignment and servicing",
    },
    topRight: {
      src: "/images/gallery/05-4.jpg",
      alt: "Replacement Colorbond sectional door",
      label: "Sectional door replacement",
    },
    bottomRight: {
      src: "/images/gallery/06-3.jpg",
      alt: "Opener tune up and remote pairing",
      label: "Opener tune up",
    },
  },
  {
    hero: {
      src: "/images/gallery/03-5.jpg",
      alt: "Full garage door replacement on a Brisbane home",
      label: "Full door replacement",
    },
    topRight: {
      src: "/images/gallery/02-5.jpg",
      alt: "Roller door curtain replacement",
      label: "Roller door repair",
    },
    bottomRight: {
      src: "/images/gallery/10-sams.jpg",
      alt: "Same day service callout completed",
      label: "Same day service callout",
    },
  },
];
...
function JobTile({
  ...
  return (
    <div className={className}>
      ...
      />
      <div className="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/75 via-black/40 to-transparent p-3 md:p-4">
        <span className="inline-block bg-brand-yellow px-3 py-1 font-display text-xs font-extrabold uppercase tracking-wide text-brand-navy md:text-sm">
          {job.label}
        </span>
      </div>
    </div>
      ...
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="text-center">
          <h2 className="font-display text-4xl font-extrabold leading-[1.05] tracking-tight md:text-5xl lg:text-6xl">
            <span className="text-brand-yellow">RECENT JOBS</span>{" "}
            <span className="text-white">Near {suburb}</span>
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-sm font-semibold uppercase tracking-[0.2em] text-white/80 md:text-base">
            A snapshot of work completed in {suburb} and surrounds
          </p>
        </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:gap-4 md:gap-6">
                    <JobTile
                      job={slide.topRight}
                      sizes="(min-width: 768px) 50vw, 50vw"
                      className="relative aspect-[4/5] w-full overflow-hidden rounded-xl shadow-xl ring-1 ring-white/10 md:aspect-auto md:min-h-[220px]"
                    />
                    <JobTile
                      job={slide.bottomRight}
                      sizes="50vw"
                      className="relative hidden aspect-auto w-full overflow-hidden rounded-xl shadow-xl ring-1 ring-white/10 md:block md:min-h-[220px]"
                    />
                  </div>
                </div>
              ))}
