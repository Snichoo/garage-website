...
const items: HelpItem[] = [
  {
    ...
    alt: "Garage door installations icon",
    href: "/garage-doors",
  },
  {
    label: "Springs",
    icon: "/images/icons/help-springs.png",
    alt: "Garage door springs icon",
    href: "/springs",
  },
  {
    label: "Openers",
    icon: "/images/icons/help-openers.png",
    alt: "Garage door openers icon",
    href: "/openers",
  },
  {
    label: "Cables",
    icon: "/images/icons/help-cables.png",
    alt: "Garage door cables icon",
    href: "/cables",
  },
  {
      ...
      <div className="relative mx-auto max-w-[1200px] px-6">
        ...
        <div className="mt-12 flex justify-center md:mt-16">
          <span className="relative inline-block font-display text-lg font-bold italic text-brand-navy md:text-xl">
            <span className="relative z-10">and more ...</span>
            <span
              aria-hidden
