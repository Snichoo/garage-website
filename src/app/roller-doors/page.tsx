...
export default async function RollerDoorsPage() {
  return (
        ...
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-10 px-6 pb-16 pt-40 md:pb-24 md:pt-48 lg:grid-cols-[1fr_1.15fr] lg:gap-12 lg:pt-40">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="max-w-xl text-base leading-relaxed text-white/85 md:text-lg">
              Roller garage doors are made of narrow horizontal slats that roll
              up into a compact drum above the opening. Known for their
              durability, security, and space-saving design, they&apos;re an
              excellent choice for garages with restricted headroom or tight
              spaces.
            </p>
